...
export default function Mentions() {
  return (
    <div className="container mx-auto mt-10 p-8 bg-gray-100 dark:bg-gray-800 rounded-2xl text-gray-700 dark:text-gray-300">
      ...
      <div className="mb-8">
        <h2 className="text-[30px]l font-bold mb-2">1. PRÉSENTATION DU SITE</h2>
        <p>
          En vertu de l'article 6 de la loi n° 2004-575 du 21 juin 2004 pour la
          confiance dans l'économie numérique, il est précisé aux utilisateurs
          du site www.laboiteautomatique.com l'identité des différents
      ...
      <div className="mb-8">
        ...
        <p>
          AxElecAuto s’efforce de fournir sur le site www.laboiteautomatique.com
      ...
      <div className="mb-8">
        ...
        <p>
          ...
          décidée par AxElecAuto, qui s’efforcera alors de communiquer
      ...
      <div className="mb-8">
        ...
        <p>
          AxElecAuto est propriétaire des droits de propriété intellectuelle ou
      ...
      <div className="mb-8">
        ...
        <p>
          ...
          www.laboiteautomatique.com, et résultant soit de l’utilisation d’un
        ...
        <p>
          ...
          protection des données. Le cas échéant, Click and Trust se réserve
      ...
      <div className="mb-8">
        ...
        <p>
          A l'occasion de l'utilisation du site www.laboiteautomatique.com,
          peuvent êtres recueillies : l'URL des liens par l'intermédiaire
          desquels l'utilisateur a accédé au site www.laboiteautomatique.com, le
        ...
        <p>
          ...
          services proposés par le site www.laboiteautomatique.com.
        ...
        <p>
          ...
          tiers. Seule l'hypothèse du rachat de AxElecAuto et de ses droits
          ...
          du site www.laboiteautomatique.com.
        </p>
        <p>
      ...
      <div className="mb-8">
        ...
        <p>
          Le site www.laboiteautomatique.com contient un certain nombre de liens
          hypertextes vers d’autres sites, mis en place avec l’autorisation de
          AxElecAuto. Cependant, AxElecAuto n’a pas la possibilité de vérifier
      ...
      <div className="mb-8">
        ...
        <p>
          ...
          www.laboiteautomatique.com est soumis au droit français. Il est fait
      ...
      <div className="mb-8">
        ...
        <p>
          L’utilisation du site Loi n° 78-17 du 6 janvier 1978, notamment
          modifiée par la loi n° 2004-801 du 6 août 2004 relative à
          l'informatique, aux fichiers et aux libertés..laboiteautomatique.com
          ...
          utilisateurs du site www.laboiteautomatique.com sont donc invités à
