...
const pageDescription =
  "Vérifiez la disponibilté de votre module de commande de boite de vitesse automatique pour votre boite automatique EDC Ford focus Diesel ";
const HeadingText = "Calculateur pour Ford Focus Diesel boite auto ";

export default function Renault() {
  return (
    <div className="relative produits">
      <Head>
        <title>Calculateur pour Ford Focus Diesel boite auto </title>
        <meta name="description" content={pageDescription} />
        <meta name="headline" content={HeadingText} />
      </Head>

      <div style={{ display: "none" }}>
        <h1>Calculateur pour Ford Focus Diesel boite auto </h1>
      </div>
        ...
        <div className="orderPrevPage group rounded-xl shadow-2xl md:p-8 transition-color  border-2 bg-white/90 border-orangevba  md:w-3/5 lg:w-3/5 xl:w-5/12 text-center">
          ...
          <div className="text-center">
            <p className="mb-4">
              ...
              Diesel Boite automatique DC4 (getrag 6DCT250)
            </p>
