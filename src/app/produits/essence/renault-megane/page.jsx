...
const pageDescription =
  "Vérifiez la disponibilté de votre module de commande de boite de vitesse automatique pour votre boite automatique EDC Renault Megane Essence";
const HeadingText = "Calculateur pour Renault Captur Diesle ";
export default function Renault() {
  return (
    <div className="relative produits">
      <Head>
        <title>Calculateur pour Renault Megane Essence DC4</title>
