        ...
        <div className="group rounded-xl shadow-2xl p-8 transition-color  border-2 bg-white/90 border-orangevba  md:w-3/5 lg:w-3/5 xl:w-5/12 text-center">
          ...
          <div className="text-center">
            <p className="mb-4">
              ...
              Captur Essence 2013 Boite automatique DC4 (getrag 6DCT250)
            </p>
            ...
            <div className="flex justify-center space-x-4 pt-4">
              <a
                ...
                className="cursor-pointer bg-orangevba hover:brightness-110 text-white font-bold py-2 px-4 text-[30px]l rounded-full shadow-lg focus:outline-none"
              >
                Commander
              </a>
              <a
                href="/prestations/installation"
                className="cursor-pointer bg-[#418FFF] hover:brightness-110 text-white font-bold py-2 px-4 rounded-full text-[30px]l shadow-lg focus:outline-none"
              >
                Contactez-nous
              </a>
            </div>
