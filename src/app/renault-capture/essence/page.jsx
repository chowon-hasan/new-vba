...
const pageDescription =
  "Vérifiez la disponibilté de votre module de commande de boite de vitesse automatique pour votre boite automatique EDC Renault Captur Essence";
const HeadingText = "Calculateur pour Renault Captur Essence";

export default function RenaultEssenceSingle() {
  return (
    <div className="relative produits">
      <Head>
        <title>Calculateur pour Renault Captur Essence</title>
        <meta name="description" content={pageDescription} />
        <meta name="headline" content={HeadingText} />
      </Head>

      <div style={{ display: "none" }}>
        <h1>Calculateur pour Renault Captur Essence</h1>
      </div>
          ...
          <div className="text-center">
            ...
            <div className="flex justify-center space-x-4 pt-4">
              <a
                ...
                className="cursor-pointer bg-orangevba hover:brightness-110 text-white py-2 px-4 text-[30px]l rounded-full shadow-lg focus:outline-none"
              >
                Commander
              </a>
              <a
                href="/prestations/installation"
                className="cursor-pointer bg-[#418FFF] hover:brightness-110 text-white py-2 px-4 rounded-full text-[30px]l shadow-lg focus:outline-none"
              >
                Contactez-nous
              </a>
            </div>
