...
const pageDescription =
  "Vérifiez la disponibilté de votre module de commande de boite de vitesse automatique pour votre boite automatique EDC Ford focus Essence";
const HeadingText = "Calculateur pour Ford Focus Essence boite auto";

export default function Renault() {
  return (
    <div className="relative produits">
      <Head>
        <title>Calculateur pour Ford Focus Essence boite auto</title>
        <meta name="description" content={pageDescription} />
        <meta name="headline" content={HeadingText} />
      </Head>

      <div style={{ display: "none" }}>
        <h1>Calculateur pour Ford Focus Essence boite auto</h1>
      </div>
